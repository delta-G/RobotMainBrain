...
//	Battery battery;
	...
	uint16_t voltages[NUM_VOLTAGES_MONITORED];
	uint16_t voltageLastReport[NUM_VOLTAGES_MONITORED];
	uint16_t voltagePins[NUM_VOLTAGES_MONITORED] = {BATTERY_ADC_PIN, V12_ADC_PIN, CURRENT_SENSOR_ADC_PIN, AUX_ADC_PIN, MAIN5_ADC_PIN, RADIO_ADC_PIN, 0};
	float voltageCals[NUM_VOLTAGES_MONITORED] = {BATTERY_ADC_CAL_FACTOR, V12_ADC_CAL_FACTOR, CURRENT_SENSOR_CAL_FACTOR, AUX_ADC_CAL_FACTOR, MAIN5_ADC_CAL_FACTOR, RADIO_ADC_CAL_FACTOR, 1};
	...
	uint8_t armDumpBuffer[ARM_DUMP_SIZE] = {0x00,0x12,0x22,0x00,0x05,0x06,0x07,0x08,0x09,0x0A,0x0B,0x0C,0x0D,0x0E,0x0F,0x10,0x11,0x12,0x13,0x14,0x15,0x3E};
